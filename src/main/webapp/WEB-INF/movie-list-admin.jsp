...
<form action="add">
		<input type="submit" class="btn btn-primary btn-lg btn-block" value="Add New Movie - Admin"/>&emsp;&emsp;&emsp;
			...
			<div class="card col-sm-3  mt-5" class="cardmargins" style="width: 15rem;background-color: #ccccff;">
				...
				<div class="card-body" style="padding:10px">
					...
					<div class="bottom-wrap">
							...
							<a href="delete?id=${mov.id }" onclick="return confirm('Do you wish to delete the movie?')" class="btn btn-warning float-right" style="color: white;"><i class="fa fa-trash"></i> Delete</a>&nbsp;
						<a href="update?id=${mov.id }" onclick="return confirm('Do you wish to edit the movie?')" class="btn btn-success float-right" style="color: white;"><i class="fa fa-pencil"></i> Edit</a>
